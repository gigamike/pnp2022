            ...
            this.createDialog = function(container) {
                var dialogOption = {
                    ...
                    body: [
                        ...
                        '<div style="text-align:center;margin-bottom:5px;"><a href="' + microsite_base_url + 'files/' + current_microsite_id + '" target="_blank">Upload Image</a></div>'
                    ].join(""),
                    footer: [
                        ...
                        $.get(
                            ...
                            for (var i = 0; i < data.length; i++) {
                                content.push([
                                    ...
                                    '<img src="' + thumbUrlPrefix + data[i].image_url + '" data-filename="' + data[i].image_url + '" data-full-url="' + fullUrlPrefix + data[i].image_url + '">',
                                    '</div>',
                                    '</div>'
                                ].join(""));
