...
<div class="row wrapper">
    ...
    <div class="col-sm-7 text-right">
        <div class="form-group">
            ...
            <a class="btn btn-md btn-primary m-b-xs" href="<?php echo base_url(); ?>plate-numbers/add">Add Plate Number</a>
            <a class="btn btn-md btn-primary m-b-xs" href="<?php echo base_url(); ?>plate-numbers/add-import">Bulk Plate Number</a>
        </div>
    </div>
</div>
