            ...
            <tr>
                <td style="display: block !important; margin: 0 auto !important; clear: both !important;">
                    <p>
                        ...
                        <br/><br/>Workspace Details:<br/><br/>
                        Workspace Name: <?php echo $partner_data['name']; ?><br/>
                        Workspace: <?php echo $partner_data['portal_name']; ?><br/>
                        Workspace Code: <?php echo $partner_data['reference_code']; ?><br/>
                    </p>
