...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form" role="form" method="POST" action="<?php echo $action_url_prefix . "3/" . $token1 . "/" . $token2 . "/" . $token3; ?>">
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 col-lg-8 col-lg-offset-2 m-t-xl">
                        ...
                        <div class="widget white-bg">
                            ...
                            <div class="form-group m-t-lg<?php
                            if (form_error('login_password') != "") {
                                echo " has-error";
                            }
                            ?>">
                                <input type="password" class="form-control input-lg" name="login_password" id="login_password" placeholder="Enter New Password" required autocomplete="off">
                                <?php echo form_error('login_password'); ?>
                            </div>
                            <div class="form-group<?php
                            if (form_error('login_password_confirm') != "") {
                                echo " has-error";
                            }
                            ?>">
                                <input type="password" class="form-control input-lg" name="login_password_confirm" placeholder="Repeat New Password" required autocomplete="off">
                                <?php echo form_error('login_password_confirm'); ?>
                            </div>
                            <div class="m-t-sm m-b-lg text-left">
                                <small class="text-muted">
                                    Your password needs to: (1) include both lower and upper case characters; (2) include at least one number or symbol; and (3) be at least <?php echo $this->config->item('mm8_system_password_length'); ?> characters long
                                </small>
                            ...
                            <button type="submit" class="btn btn-primary btn-radius-sm btn-lg block full-width m-b">Change Password</button>
