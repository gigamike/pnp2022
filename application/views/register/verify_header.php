...
<html>
    <head>
        ...
        <title><?php echo $this->config->item('mm8_product_html_title'); ?> | Register</title>
        ...
        <link href="<?php echo asset_url(); ?>css/plugins/toastr/toastr.min.css" rel="stylesheet" <?php if (SENTRY_ENABLED) { ?>onerror="onCssLoadError(this.href);"<?php } ?>>
        <link href="<?php echo asset_url(); ?>css/plugins/sweetalert/sweetalert.css" rel="stylesheet" <?php if (SENTRY_ENABLED) { ?>onerror="onCssLoadError(this.href);"<?php } ?>>
        <link href="<?php echo asset_url(); ?>css/plugins/jasny/jasny-bootstrap.min.css" rel="stylesheet" <?php if (SENTRY_ENABLED) { ?>onerror="onCssLoadError(this.href);"<?php } ?>>
        <link href="<?php echo asset_url(); ?>css/animate.css" rel="stylesheet" <?php if (SENTRY_ENABLED) { ?>onerror="onCssLoadError(this.href);"<?php } ?>>
        <link href="<?php echo asset_url(); ?>css/utilihub-hub.min.css" rel="stylesheet" <?php if (SENTRY_ENABLED) { ?>onerror="onCssLoadError(this.href);"<?php } ?>>
        ...
        <script type="text/javascript">var baseUrl = '<?php echo base_url(); ?>'; var baseCountry = '<?php echo $this->config->item('mm8_country_code'); ?>'; var baseDateFormat = '<?php echo $this->config->item('mm8_global_date_format'); ?>';</script>
