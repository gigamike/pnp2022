...
<div class="modal fade" id="reopenReplyModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row m-b">
                    <div class="col-sm-12 ">
                        <h2>Re-open and reply<span class="text-danger">*</span></h2>
                    </div>
                </div><!-- header -->
                <div class="ibox float-e-margins white-bg">
                    <div class="ibox-content">
                        <form id="reopenReplyForm">
                            <input type="hidden" name="ticket_id" value="<?php echo $ticket->id; ?>">
                            
                            <div class="form-group">
                                <textarea name="reopen_reply_body" id="reopen_reply_body" class="tinymce"></textarea>
                                ...
                                <div class="col-sm-12 m-b-n-xs">
                                    <div class="pull-right">
                                        <div class="btn-group dropup" id="reply_wrapper">
                                            <button type="button" class="btn btn-primary" id="reopenReplySendBtn">Re-open and reply</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
