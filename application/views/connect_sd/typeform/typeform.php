...
<form id="typeformForm">
    <input type="hidden" name="uriPath" id="uriPath" value="<?php echo $uriPath; ?>">

    <input type="hidden" name="typeformSessionCode" id="typeformSessionCode" value="<?php echo $typeformSession->reference_code; ?>">
