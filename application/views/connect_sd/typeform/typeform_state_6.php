    ...
    <div class="col-md-12 m-b-sm left">
        ...
        <div class="chat-body clearfix">
            <div class="callout">
                ...
                <p class="text-16">Apologies, all of our Agents are currently offline. In a few words, can you please tell me the nature of your enquiry, then click OK to add further details...</p>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-10 col-sm-offset-1">
        <div class="form-group">
            <input type="text" name="ticketSubject" attr-target-field="ticketSubject" class="form-control input-lg" placeholder="Problem overview" value="" required>
        </div>
    </div>
</div>
