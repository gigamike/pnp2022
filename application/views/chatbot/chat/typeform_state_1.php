    ...
    <div class="col-md-12 m-b-sm left">
        ...
        <div class="chat-body clearfix">
            <div class="callout">
                ...
                <p class="text-16">Hi, I'm <?php echo $chatbotAttributes['first_name']; ?> <?php echo $chatbotAttributes['last_name']; ?>, hope you're having a great day. Before we continue, have you checked our knowledge base for the answer?</p>
            </div>
        </div>
    </div>
</div>
