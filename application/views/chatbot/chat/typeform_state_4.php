    ...
    <div class="col-md-12 m-b-sm left">
        ...
        <div class="chat-body clearfix">
            <div class="callout">
                ...
                <p class="text-16">Please enter your name...</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <input type="text" name="firstName" attr-target-field="firstName" class="form-control input-lg" placeholder="First Name" value="" required>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <input type="text" name="lastName" attr-target-field="lastName" class="form-control input-lg" placeholder="Last Name" value="" required>
                </div>
            </div>
    </div>
</div>
<div class="row navigator-div m-t-sm m-t-sm">
