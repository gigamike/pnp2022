    ...
    <div class="col-md-12 m-b-sm left">
        ...
        <div class="chat-body clearfix">
            <div class="callout">
                ...
                <p class="text-16">Please enter your mobile phone number...</p>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-10 col-sm-offset-1">
        <div class="form-group">
            <input type="text" class="form-control input-lg" name="mobile_phone" id="mobile_phone" placeholder="E.g 09086087306" required>
        </div>
    </div>
</div>
