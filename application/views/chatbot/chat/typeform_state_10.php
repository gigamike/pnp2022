    ...
    <div class="col-md-12 m-b-sm left">
        ...
        <div class="chat-body clearfix">
            <div class="callout">
                ...
                <p class="text-16">Optional (Bounty and rewards). Do you have a Unionbank account?</p>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-10 col-sm-offset-1">
        <div class="form-group">
            <input type="text" name="unionbank_account" class="form-control input-lg" placeholder="e.g. 101130011234" value="" required>
        </div>
    </div>
</div>
