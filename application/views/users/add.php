                ...
                <div class="ibox-content">
                    ...
                    <div class="row form-group">
                     ...
                     <div class="row form-group">
                        <div class="col-sm-6">
                            ...
                            <input type="email" name="email" id="email" class="form-control input-lg" value="" required>
                        </div><!-- column -->
                        <div class="col-sm-6">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="position" id="position" class="form-control input-lg" value="" required>
                        </div><!-- column -->
                        <div class="col-sm-6">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-6">
                            ...
                            <select name="devices[]" id="devices" class="select2-input form-control input-sm filter-set filter-value" style="width:100%;" multiple>
                                ...
                                <option value="<?php echo $device->id; ?>"><?php echo $device->location; ?> (<?php echo $device->u_code; ?>)</option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </select>
                        </div><!-- column -->
